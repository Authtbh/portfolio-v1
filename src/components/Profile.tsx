...
const Profile = () => {
  ...
  return (
    <>
        ...
        <div className="meow text-clamp ml-5 md:ml-36 mt-20 w-80 text-primary-brown xl:ml-48 "><h1 className="w-80">Auth</h1></div>
...
Transforming Designs into Reality.</h4></div>
      ...
      <div className="flex md:ml-36 md:gap-5 mt-5 ml-2 gap-2">
