...
const Profile = () => {
  ...
  const [birthdate, setBirthdate] = useState(
    new Date("August 22, 2008 20:00:00"),
  );
    ...
    const fetchDiscordStatus = async () => {
      try {
        const response = await fetch(
          "https://api.lanyard.rest/v1/users/1045909242101633126",
        );
    ...
    <>
      ...
      <div className="flex md:ml-36 md:gap-5 mt-5 ml-2 gap-2 transition-all">
        ...
        <div className="hover:bg-idktbh rounded-xl transition-all">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            href="https://discord.com/users/1045909242101633126"
          >
            <svg
              width="24px"
              height="24px"
        ...
        <div className="hover:bg-idktbh rounded-xl transition-all">
          <a
            data-tooltip-id="my-tooltip"
            data-tooltip-content="AuthFr@proton.me"
            data-tooltip-place="top"
            className="transition-all flex justify-center items-center w-[50px] h-[50px] bg-transparent border-none rounded-[10px] cursor-pointer group-hover:bg-elevation_one active:scale-[95%] offset_ring"
            target="_blank"
            rel="noreferrer"
            href="mailto:AuthFr@proton.me"
          >
            <svg
              width="24px"
              height="24px"
      ...
      <div className="w-auto  md:w-96 md:absolute right-0 md:-mt-81 mr-16 text-primary-brown mt-12 ml-3">
        ...
        <h5 className="brrrr w-full md:w-96 mt-4 text-sm  ">
          ...
          <span className="bio_span bg-idkfr rounded-md font-medium">2022</span>
          ...
          here. Currently struggling with blockchain and rust.
        </h5>
      </div>
